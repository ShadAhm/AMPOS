package com.example.thisi.applicationx.data;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean loginAdminEmployee(String username, String password) {
        ...
        db.beginTransaction();
        try {
            Cursor res = db.rawQuery("SELECT * FROM " + EMPLOYEE_TABLE_NAME + " WHERE EMP_CODE = '" + username + "' AND EMP_PASSWORD = '" + password + "' AND EMP_LVL >= 9;", null);
